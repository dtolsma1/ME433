...
int main() {
    ...
    unsigned char my_msg[] = "hello world";
//    print_array(10, 10, my_msg);
    unsigned char var_name[] = "fps";
    
//    int this = 10;
//    print_variable_value(10, 24, var_name, this);
    
    while (1) {
        _CP0_SET_COUNT(0);
        ssd1306_update();
        int fps = 24000000 / (int)_CP0_GET_COUNT();    //variable to print
        print_variable_value(10, 24, var_name, fps);
        print_array(10,10, my_msg);
...
void delay() {
    _CP0_SET_COUNT(0);
    while (_CP0_GET_COUNT() < 24000000) {}; // 1 Hz
}
